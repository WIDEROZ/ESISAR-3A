...
On a alors,
$$\pi_{2}^{(n)} = 0.15 \times \frac{0.6}{0.05} \times (0.65^{n}-0.6^{n}) = 1.8(0.65^{n}-0.6^{n})$$
Donc, 
$$\pi_{1}^{(n)} = 0.2 \times 0.65^{n-1} + \pi_{1}^{(n-1)} + 0.54(0.65^{n-1} - 0.6^{n-1})$$
Alors, 
$$\pi_{1}^{(n)} = \pi_{1}^{(n-1)} + 0.2 \times 0.65^{n-1} + 0.54(0.65^{n-1} - 0.6^{n-1})$$
Encore par récurrence rapide : 
$$\pi_{1}^{(n)} = 0.2\sum_{k = 0}^{n-1}0.65^{k} + 0.54\sum_{k = 0}^{n-1}0.65^{k} - 0.54 \sum_{k = 0}^{n-1} 0.6^{k}$$
Alors, 
$$\pi_{1}^{(n)} = \frac{0.2}{0.35}(1-0.65^{n}) + \frac{0.54}{0.35}(1-0.65^{n}) - \frac{0.54}{0.4}(1-0.6^{n})$$
Donc, 
$$\pi_{1}^{(n)} = \frac{74}{35}(1-0.65^{n}) - \frac{27}{20}(1-0.6^{n}) \underset{n \to +\infty}{\longrightarrow} \frac{107}{140}$$
