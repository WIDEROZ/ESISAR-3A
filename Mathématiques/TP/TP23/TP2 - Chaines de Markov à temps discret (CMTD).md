...
##### 2.
###### a.
$$f_{2, 6} = p_{2, 6} + \sum_{k \in \{ 1, 2, 3, 4, 5 \}} p_{2, k} f_{k, 6} = \frac{1}{2}f_{1, 6} + \frac{1}{2} f_{4, 6}$$$$f_{1, 6} = \sum_{k \in \{ 1, 2, 3, 4,5 \}} p_{1, k} f_{k, 6} = \frac{1}{2}f_{1, 6} + \frac{1}{2} f_{2, 6} \Leftrightarrow f_{1, 6} = f_{2, 6}$$
$$f_{4, 6} = \sum_{k \in \{ 1, 2, 3, 4, 5 \}} p_{4, k}f_{k, 6} = f_{3, 6}$$
$$f_{3, 6} = \sum_{k \in \{ 1, 2, 3,4, 5 \}} p_{3, k} f_{k, 6} = \frac{1}{4} + \frac{1}{4} + \frac{1}{4}(f_{1, 6}+f_{2, 6}) = \frac{1}{2}+\frac{1}{2}f_{2, 6} $$
Alors, 
$$f_{2, 6} = \frac{1}{2}\left( f_{2, 6} + \frac{1}{2}+\frac{1}{2}f_{2, 6} \right) = \frac{3}{4}f_{2, 6} + \frac{1}{}$$
