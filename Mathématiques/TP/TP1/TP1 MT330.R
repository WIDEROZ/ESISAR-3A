...
temps2 <- c(2.13, 0.63, 0.70, 8.14, 0.12, 3.75, 0.20, 0.64, 0.22, 2.36, 0.10, 2.14, 4.59, 8.54, 0.36, 3.14, 15.07, 1.33, 1.60, 0.22);
...
curve(exp1_dens(x, lba), from = 0, to = max(temps2), add = TRUE, col = rgb(1, 0, 0))
