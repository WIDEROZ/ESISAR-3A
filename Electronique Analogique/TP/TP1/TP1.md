...
Pour allumer la diode il faut que la tension a la borne de la diode soit négative alors il faut que l'interrupteur soit fermé. 
Pour l'éteindre il faut que que la tension soit positive ou nulle alors : il faut que $V_{i} \approx 0$ donc que l'interrupteur soit ouvert. 
